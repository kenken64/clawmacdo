...
## ✨ What's New in v0.44.4

- **`skill-deploy` subcommand** — upload a `.zip` of OpenClaw skills to a deployed instance; extracts into `~/.openclaw/workspace/` and restarts the gateway automatically
